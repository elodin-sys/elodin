...
[elodin-macos]: https://storage.googleapis.com/elodin-releases/v0.3.14/elodin-aarch64-apple-darwin.tar.gz
[elodin-macos-sha256]: https://storage.googleapis.com/elodin-releases/v0.3.14/elodin-aarch64-apple-darwin.tar.gz.sha256
[elodin-linux]: https://storage.googleapis.com/elodin-releases/v0.3.14/elodin-x86_64-unknown-linux-gnu.tar.gz
[elodin-linux-sha256]: https://storage.googleapis.com/elodin-releases/v0.3.14/elodin-x86_64-unknown-linux-gnu.tar.gz.sha256
[elodin-windows]: https://storage.googleapis.com/elodin-releases/v0.3.14/elodin-x86_64-pc-windows-msvc.zip
[elodin-windows-sha256]: https://storage.googleapis.com/elodin-releases/v0.3.14/elodin-x86_64-pc-windows-msvc.zip.sha256
...
[ball.py]: https://raw.githubusercontent.com/elodin-sys/elodin/main/libs/nox-py/examples/ball.py
