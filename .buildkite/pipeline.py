    ...
    group(
        ...
        steps=[
            ...
            nix_step(
                ...
                label="cargo test",
                command=[
                    "cargo test --release --exclude elodin-db --exclude elodin-db-tests -- -Z unstable-options --format json --report-time | buildkite-test-collector",
                    "cargo test --release -p elodin-db --lib -- --test-threads=1 -Z unstable-options --format json --report-time | buildkite-test-collector",
                    "cargo test --release -p elodin-db-tests -- --test-threads=1 -Z unstable-options --format json --report-time | buildkite-test-collector",
                ],
                env={
                    "RUSTC_BOOTSTRAP": "1",
