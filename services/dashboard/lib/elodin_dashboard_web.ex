defmodule ElodinDashboardWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: ElodinDashboardWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {ElodinDashboardWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: ElodinDashboardWeb.Router,
        statics: ElodinDashboardWeb.static_paths()
    end
  end
