defmodule ParacosmDashboardWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: ParacosmDashboardWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {ParacosmDashboardWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: ParacosmDashboardWeb.Router,
        statics: ParacosmDashboardWeb.static_paths()
    end
  end
