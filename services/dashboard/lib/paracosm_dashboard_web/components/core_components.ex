defmodule ParacosmDashboardWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ParacosmDashboardWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ParacosmDashboardWeb.Gettext, "errors", msg, opts)
    end
  end
