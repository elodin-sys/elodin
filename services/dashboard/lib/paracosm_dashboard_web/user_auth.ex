defmodule ParacosmDashboardWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule ParacosmDashboardWeb.PageLive do
        use ParacosmDashboardWeb, :live_view

        on_mount {ParacosmDashboardWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{ParacosmDashboardWeb.UserAuth, :ensure_authenticated}] do
