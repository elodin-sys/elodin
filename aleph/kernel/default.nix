{
  ...
  # Define source configurations for different branches
  kernelSources = {
    default = {
      owner = "elodin-sys";
    ...
    no_otg = {
      owner = "elodin-sys";
      repo = "aleph-orin-baseboard-kernel-5-10";
      rev = "b33946c6b447ca4c36ccd055d737ce7e399a99e9";
      hash = "sha256-tGkhZl0JcB4d7+FFY89uKR5pmxZfGUtuAMghBU+7gns=";
    };
  };

  #selectedSource = kernelSources.${kernelSource} or kernelSources.branch_a;
  selectedSource = kernelSources.${kernelSource};
in
  buildLinux (args
    // {
