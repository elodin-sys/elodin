...
def actuator_dynamics(
    ...
    # Update elevator
    delta_e_new = actuator_dynamics_single(delta_e, delta_e_cmd, tau, max_rate_rad, max_def_rad, dt)

    # Update aileron
    delta_a_new = actuator_dynamics_single(delta_a, delta_a_cmd, tau, max_rate_rad, max_def_rad, dt)
