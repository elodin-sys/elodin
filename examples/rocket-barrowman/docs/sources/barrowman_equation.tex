...
\textbf{Implementation:} This document directly corresponds to the Python implementation in \texttt{openrocket\_aero.py} and \texttt{flight\_solver.py}. Each equation is referenced in the code comments. See \texttt{README.md} for a complete equation-to-code mapping and connection to the original Barrowman papers.
\end{abstract}
...
NACA CR-68692, 1966.
Available at: \url{http://www.apogeerockets.com/Education/downloads/barrowman_report.pdf}
...
Available in this repository: \texttt{context/barrowman.md}
