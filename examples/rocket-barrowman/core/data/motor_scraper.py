                    ...
                    motors.append(
                        {
                            ...
                            "totalImpulse": motor.get("totImpulseNs", 0.0)
                            or motor.get("totalImpulse", 0.0),
                            "avgThrust": motor.get("avgThrustN", 0.0)
                            or motor.get("avgThrust", 0.0),
                            "maxThrust": motor.get("maxThrustN", 0.0)
                            or motor.get("maxThrust", 0.0),
    ...
    def get_motor_data(
        ...
        try:
            ...
            if total_weight_g and total_weight_g > 0:
                ...
                total_mass = motor_info.get("totalMass") or motor_info.get("total_mass") or 0.0
            ...
            if prop_weight_g and prop_weight_g > 0:
                ...
                # Fallback to kg values if grams not available
                propellant_mass = (
                    motor_info.get("propellantMass") or motor_info.get("propellant_mass") or 0.0
                )
            ...
            if total_mass > 0 and propellant_mass > 0:
                ...
                case_mass = motor_info.get("caseMass") or motor_info.get("case_mass") or 0.0
