...
class OpenRocketSimulator:
    ...
    def rk4_step(self, state: SimulationState, dt: float) -> SimulationState:
        ...
        new_state.motor_time += (
            dt / 6 * (k1.motor_time + 2 * k2.motor_time + 2 * k3.motor_time + k4.motor_time)
        )
    ...
    def run(
        self, launch_angle: Optional[float] = None, launch_direction: Optional[float] = None
