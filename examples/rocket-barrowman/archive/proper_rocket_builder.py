...
def build_proper_rocket():
    ...
    centering_ring_mid = CenteringRing(
        name="Middle Centering Ring", outer_radius=0.023, inner_radius=0.015, thickness=0.006
    )
    ...
    centering_ring_aft = CenteringRing(
        name="Aft Centering Ring", outer_radius=0.023, inner_radius=0.015, thickness=0.006
    )
    ...
    launch_lug_aft = LaunchLug(
        name="Aft Launch Lug", length=0.03, outer_radius=0.0025, thickness=0.0005
    )
