...
class RocketVisualizer:
    ...
    def draw_body_tube(self, tube: BodyTube, ax, color="lightgray"):
        ...
        for i in range(n_segments - 1):
            ...
            verts = [[x_start, y1, z1], [x_end, y1, z1], [x_end, y2, z2], [x_start, y2, z2]]
    ...
    def plot_assembly(self, show_cg_cp=True, show_dimensions=True):
        ...
        # Set aspect ratio
        max_range = max(cp_x + 0.2, self.rocket.body_diameter * 2)
...
def visualize_rocket_comparison(
    rocket1: Rocket, rocket2: Rocket, title1: str = "Rocket 1", title2: str = "Rocket 2"
):
