    ...
    world.schematic(
        ...
        tabs {
            hsplit name = "Viewport" {
                viewport name=Viewport pos="drone.world_pos + (0,0,0,0, 2,2,2)" look_at="drone.world_pos" fov=30.0 show_grid=#true create_frustum=#true show_frustums=#true frustums_color="(255,255,0)" frustums_thickness=0.012 near=0.05 far=5.0 active=#true
                viewport name="Drone Side View" pos="drone.world_pos + (0,0,0,0, -3.0,1.0,1.5)" look_at="drone.world_pos" fov=30.0 create_frustum=#true show_frustums=#true frustums_color="(255,165,0)" frustums_thickness=0.012 near=0.05 far=7.0
                vsplit share=0.4 {
