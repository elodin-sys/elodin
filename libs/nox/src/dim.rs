...
// source: https://docs.rs/nalgebra/latest/src/nalgebra/base/dimension.rs.html#206-213
...
// source: https://docs.rs/nalgebra/latest/src/nalgebra/base/dimension.rs.html#134
macro_rules! dim_ops(
    ($($DimOp:    ident, $DimNameOp: ident,
       ...
       $ResOp: ident);* $(;)*) => {$(
        ...
        impl<const D: usize> $DimOp<Dyn> for Const<D> {
            type Output = Dyn;

            #[inline]
            fn $op(self, _: Dyn) -> Dyn {
                Dyn
            }
        }
