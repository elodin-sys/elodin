...
class SpatialTransform:
    ...
    @staticmethod
    def from_angular(quaternion: jax.typing.ArrayLike) -> SpatialTransform: ...
    @staticmethod
    def from_axis_angle(
...
class Quaternion:
    ...
    def __matmul__(
        self, other: jax.Array | SpatialTransform | SpatialMotion | SpatialForce
    ) -> jax.Array: ...
...
class QueryInner:
    ...
    @staticmethod
    def from_builder(
        builder: PipelineBuilder, names: list[str]
    ) -> QueryInner: ...
    def insert_into_builder(self, builder: PipelineBuilder) -> None: ...

class GraphQueryInner:
    def arrays(self, from_query: QueryInner, to_query: QueryInner) -> dict[int, Tuple[list[jax.Array], list[jax.Array]]]: ...
    @staticmethod
    def from_builder(
        builder: PipelineBuilder, edge_name: str, reverse: bool
    ) -> GraphQueryInner: ...
    def insert_into_builder(self, builder: PipelineBuilder) -> None: ...
    def map(self, from_query: QueryInner, to_query: QueryInner, ty: jax.typing.ArrayLike, f: Metadata) -> QueryInner: ...
...
class GraphEntity:
    def __init__(self, entity_id: EntityId, components: list[GraphComponent]): ...
class GraphComponent:
    def __init__(self, component_name: str, indexes: list[int]): ...

def six_dof(time_step: float, sys: Any = None, integrator: Integrator = Integrator.Rk4) -> RustSystem: ...
