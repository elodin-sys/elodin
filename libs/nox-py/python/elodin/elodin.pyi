...
class WorldBuilder:
    ...
    def run(self, sys: Any, time_step: Optional[float] = None, client: Optional[Client] = None): ...
...
class QueryInner:
    ...
    @staticmethod
    def from_builder(builder: PipelineBuilder, ids: list[ComponentId]) -> QueryInner: ...
...
class GraphQueryInner:
    ...
    @staticmethod
    def from_builder(builder: PipelineBuilder, edge_id: ComponentId, ids: list[ComponentId]) -> GraphQueryInner: ...
    def insert_into_builder(self, builder: PipelineBuilder) -> None: ...
