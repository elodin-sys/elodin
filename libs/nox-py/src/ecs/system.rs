...
use crate::ecs::{World, component_array::ComponentArray};
...
impl<'a> SystemBuilder<'a> {
    ...
    pub fn to_compiled_system(&self) -> Result<CompiledSystem, crate::Error> {
    ...
    pub fn init_with_column(&mut self, id: ComponentId) -> Result<(), crate::Error> {
    ...
    pub fn get_or_init_var(&mut self, id: ComponentId) -> Result<ComponentArray<()>, crate::Error> {
...
impl CompiledSystem {
    pub fn insert_into_builder(self, builder: &mut SystemBuilder) -> Result<(), crate::Error> {
        let mut args = vec![];
...
) -> Result<CompiledSystem, crate::Error> {
...
impl System for () {
    type Arg = ();
    type Ret = ();
    fn init(&self, _builder: &mut SystemBuilder) -> Result<(), crate::Error> {
        Ok(())
    }

    fn compile(&self, _builder: &World) -> Result<CompiledSystem, crate::Error> {
        let func = NoxprFn {
            args: vec![],
