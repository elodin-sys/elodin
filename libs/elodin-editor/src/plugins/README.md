...
| `env_asset_source` | 2025-09-26 | Active | Configures the default `AssetServer` source from `ELODIN_ASSETS` and warns on invalid paths. | [README.md](env_asset_source/README.md) |
