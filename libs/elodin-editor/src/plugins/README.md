...
| `kdl_asset_source` | 2026-03-18 | Active | Registers a custom Bevy `AssetSource` for `.kdl` files with debounced file watching and symlink support. | [README.md](kdl_asset_source/README.md) |
