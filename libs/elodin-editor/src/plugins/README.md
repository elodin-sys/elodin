...
| `frustum_intersection` | 2026-02-24 | Active | Builds and renders a POC mesh for `frustum ∩ ellipsoid` on viewports with `show_frustums`, using CPU SDF + marching tetrahedra. | [README.md](frustum_intersection/README.md) |
