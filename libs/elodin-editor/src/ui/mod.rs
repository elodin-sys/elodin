...
use bevy_egui::{
    EguiContext, EguiContexts, EguiPreUpdateSet, EguiTextureHandle,
    ...
    fn ctx_system(
        ...
        egui::TopBottomPanel::top("title_bar")
            .frame(
                ...
                .inner_margin(
                    egui::Margin::same(titlebar_margin)
                        .left(16.0)
...
impl RootWidgetSystem for MainLayout<'_, '_> {
    ...
    fn ctx_system(
        ...
        let titlebar_icons = TitlebarIcons {
            icon_fullscreen: contexts.add_image(EguiTextureHandle::Weak(images.icon_fullscreen.id())),
            icon_exit_fullscreen: contexts.add_image(EguiTextureHandle::Weak(images.icon_exit_fullscreen.id())),
